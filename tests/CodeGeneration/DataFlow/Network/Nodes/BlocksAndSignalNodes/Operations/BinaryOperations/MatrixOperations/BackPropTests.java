...
class BackPropTests {
    ...
    //Todo; A "Perfect" test, should return a zero-only matrix

    Source s1, s2;
    Matrix target;
    ArrayList<BinaryAbstractOperation> operations;
    ArrayList<Matrix> expecteds;
    ...
    void beforeEach() {
        ...
        expecteds.add(new MatrixBuilder().addRow(0.3899999999999997, 1.4299999999999993).addRow(0.08999999999999792, -1.970000000000002).build());
        expecteds.add(new MatrixBuilder().addRow(-0.10200000000000062, 0.0539999999999996).addRow(-1.138000000000001, -0.0740000000000012).build());
        expecteds.add(new MatrixBuilder().addRow(2.7, 1.7999999999999998).addRow(3.5999999999999996, 6.3).build());
        expecteds.add(new MatrixBuilder().addRow(2.7, 1.7999999999999998).addRow(3.5999999999999996, 6.3).build());
        expecteds.add(new MatrixBuilder().addRow(-0.2211217743525022, 0.702479338842975).addRow(0.2377095534319317, 0.0).build());
        expecteds.add(new MatrixBuilder().addRow(0.07461834907074548, -1.2453042824943645).addRow(-0.3517807013636637, -0.0).build());
        expecteds.add(new MatrixBuilder().addRow(2.986999999999999, 0.6794999999999999).addRow(2.65625, 0.0).build());
        expecteds.add(new MatrixBuilder().addRow(0.7209999999999999, 1.4722499999999998).addRow(5.3125, 0.0).build());
        expecteds.add(new MatrixBuilder().addRow(-2.7, 0.0).addRow(0.0, -0.9000000000000004).build());
        expecteds.add(new MatrixBuilder().addRow(2.7, 0.0).addRow(0.0, 0.9000000000000004).build());
    }

    @RepeatedTest(5)
    void someThing(RepetitionInfo r) {
        ...
        assertEquals(expecteds.get(expectedIndex + 0), operation.getResultBackpropagation(operation.getInputChannels().get("in1")));
        assertEquals(expecteds.get(expectedIndex + 1), operation.getResultBackpropagation(operation.getInputChannels().get("in2")));
